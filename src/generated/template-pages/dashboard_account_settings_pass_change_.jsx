    			...
    			<div className="position-relative">
    				...
    				<nav className="dasboard-main-nav pt-30 pb-30 bottom-line">
    					<ul className="style-none">
    						...
    						<li className="plr"><a href="/dashboard/account-settings" className="d-flex w-100 align-items-center active">
    			...
    			<div className="position-relative">
    				...
    				<header className="dashboard-header">
    					<div className="d-flex align-items-center justify-content-end">
    						<h4 className="m0 d-none d-lg-block">Change Password</h4>
    				...
    				<div className="bg-white card-box border-20">
                        <form action="#">
                            ...
                            <div className="button-group d-inline-flex align-items-center">
                                <a href="#" className="dash-btn-two tran3s">Save & Updated</a>
                            </div>	
                        </form>
                    </div>
