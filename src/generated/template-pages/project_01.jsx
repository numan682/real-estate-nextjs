    ...
    <div className="main-page-wrapper">
    		...
    		<div className="project-section-one mt-150 xl-mt-100">
    			<div className="container">
    				...
    				<div id="isotop-gallery-wrapper" className="grid-3column pt-40 xl-pt-10">
                        ...
                        <div className="isotop-item house flat">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_01.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item villa">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_02.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item apartments">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_03.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item villa">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_04.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item house">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_05.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item apartments flat">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_06.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item villa">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_07.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item apartments">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_08.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
                        ...
                        <div className="isotop-item house flat">
                            <div className="project-block-one mt-50 lg-mt-30">
                                <figure className="image-wrapper m0 position-relative z-1 overflow-hidden">
                                    <img src="/images/project/img_09.jpg" alt="" className="w-100" />
                                    <a href="/project_details_01" className="btn-four inverse rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </figure>
                            </div>
