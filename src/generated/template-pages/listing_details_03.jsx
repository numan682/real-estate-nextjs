                                ...
                                <div className="position-relative z-1 overflow-hidden border-20">
                                    ...
                                    <div className="theme-sidebar-one d-none d-xl-block">
                                        <div className="agent-info bg-white border-20 p-30">
                                            <img src="/images/lazy.svg" data-src="/images/agent/img_06.jpg" alt="" className="lazy-img rounded-circle ms-auto me-auto avatar" />
                                            <div className="text-center mt-25 xl-mt-20">
                                            ...
                                            <div className="divider-line mt-40 xl-mt-30 mb-45 pt-20">
                                    ...
                                    <div className="carousel-inner">
                                        <div className="carousel-item active">
                                            <img src="/images/listing/img_52.jpg" alt="" className="border-20 w-100" />
                                        </div>
                                        <div className="carousel-item">
                                            <img src="/images/listing/img_53.jpg" alt="" className="border-20 w-100" />
                                        </div>
                                        <div className="carousel-item">
                                            <img src="/images/listing/img_54.jpg" alt="" className="border-20 w-100" />
                                        </div>
                                        <div className="carousel-item">
                                            <img src="/images/listing/img_55.jpg" alt="" className="border-20 w-100" />
                                        </div>
                                        <div className="carousel-item">
                                            <img src="/images/listing/img_56.jpg" alt="" className="border-20 w-100" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12">
                                <div className="position-relative mt-25 xs-mt-10">
                                    <div className="carousel-indicators d-flex justify-content-between justify-content-xl-start position-relative w-100 h-100">
                                        <button type="button" data-bs-target="#media_slider" data-bs-slide-to="0" className="active" aria-current="true" aria-label="Slide 1">
                                            <img src="/images/listing/img_43_s.jpg" alt="" className="border-10 w-100" />
                                        </button>
                                        <button type="button" data-bs-target="#media_slider" data-bs-slide-to="1" aria-label="Slide 2">
                                            <img src="/images/listing/img_44_s.jpg" alt="" className="border-10 w-100" />
                                        </button>
                                        <button type="button" data-bs-target="#media_slider" data-bs-slide-to="2" aria-label="Slide 3">
                                            <img src="/images/listing/img_45_s.jpg" alt="" className="border-10 w-100" />
                                        </button>
                                        <button type="button" data-bs-target="#media_slider" data-bs-slide-to="3" aria-label="Slide 4">
                                            <img src="/images/listing/img_46_s.jpg" alt="" className="border-10 w-100" />
                                        </button>
                                        <button type="button" data-bs-target="#media_slider" data-bs-slide-to="4" aria-label="Slide 5">
                                            <img src="/images/listing/img_56_s.jpg" alt="" className="border-10 w-100" />
                                        </button>
                                    </div>
    					...
    					<div className="col-xl-8">
                            <div className="bg-white shadow4 border-20">
                                ...
                                <div className="property-video-tour border-top p-40">
                                    <h4 className="mb-30">Video Tour</h4>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header">
                                                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOneA" aria-expanded="false" aria-controls="collapseOneA">
                                                        <div className="d-flex justify-content-between w-100">
                                                            ...
                                                            <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_56.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">1370</span> sqft</span>
                                                                </li>
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_48.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">03</span> bed</span>
                                                                </li>
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_57.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">02</span> bath</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </button>
                                                ...
                                                <div id="collapseOneA" className="accordion-collapse collapse show" data-bs-parent="#accordionTwo">
                                                    <div className="accordion-body">
                                                        <img src="/images/listing/floor_3.jpg" alt="" className="w-100 border-10" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item">
                                                <h2 className="accordion-header">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoA" aria-expanded="false" aria-controls="collapseTwoA">
                                                        <div className="d-flex justify-content-between w-100">
                                                            <span className="fw-500 color-dark">2nd Floor</span>
                                                            <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_56.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">1145</span> sqft</span>
                                                                </li>
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_48.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">02</span> bed</span>
                                                                </li>
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_57.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">02</span> bath</span>
                                            ...
                                            <div className="accordion-item">
                                                <h2 className="accordion-header">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThreeA" aria-expanded="true" aria-controls="collapseThreeA">
                                                        <div className="d-flex justify-content-between w-100">
                                                            <span className="fw-500 color-dark">3rd Floor</span>
                                                            <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_56.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">1245</span> sqft</span>
                                                                </li>
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_48.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">02</span> bed</span>
                                                                ...
                                                                <li>
                                                                    <img src="/images/lazy.svg" data-src="/images/icon/icon_57.svg" alt="" className="lazy-img icon" />
                                                                    <span><span className="fw-500">01</span> bath</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </button>
