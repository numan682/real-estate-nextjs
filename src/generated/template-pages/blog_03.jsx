    ...
    <div className="main-page-wrapper">
    		...
    		<div className="inner-banner-one inner-banner bg-pink text-center z-1 pt-160 lg-pt-130 pb-160 xl-pb-120 md-pb-80 position-relative">
    			<div className="container">
                    <h3 className="mb-35 xl-mb-20 pt-15">Blog Full Width</h3>
    			...
    			<div className="container">
                    <div className="blog-filter-nav">
                        <ul className="style-none d-flex justify-content-center flex-wrap isotop-menu-wrapper">
                            ...
                            <li data-filter=".mortgage">Mortgage</li>
                            <li data-filter=".sale">For Sale</li>
                            <li data-filter=".home">Home</li>
                            <li data-filter=".flat">Flat</li>
                        </ul>
                    </div>
    				<div id="isotop-gallery-wrapper" className="grid-2column pt-60 lg-pt-40">
                        <div className="grid-sizer"></div>
                        <div className="isotop-item villa sale">
                            <article className="blog-meta-one mb-70 lg-mb-40">
                                <figure className="post-img border-25 position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_01.jpg)" }}>
                                ...
                                <div className="post-data">
                                    ...
                                    <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                                        ...
                                        <a href="/blog_details" className="read-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i className="bi bi-arrow-up-right"></i></a>
                                    </div> 
                                </div>
                            </article>
                        ...
                        <div className="isotop-item apartments mortgage home">
                            <article className="blog-meta-one mb-70 lg-mb-40" data-wow-delay="0.1s">
                                <figure className="post-img border-25 position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_02.jpg)" }}>
                        ...
                        <div className="isotop-item villa mortgage home flat">
                            <article className="blog-meta-one mb-70 lg-mb-40">
                                <figure className="post-img border-25 position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_13.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link date tran3s">07 FEB</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Rashed Kabir .</a> 7 min</div>
                                    <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                                        <a href="/blog_details" className="blog-title"><h4>In a laoreet purus. Integer turpis quam, laoreet</h4></a>
                                        <a href="/blog_details" className="read-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i className="bi bi-arrow-up-right"></i></a>
                                    </div> 
                                </div>
                            </article>
                        ...
                        <div className="isotop-item apartments sale flat">
                            <article className="blog-meta-one mb-70 lg-mb-40">
                                <figure className="post-img border-25 position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_12.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link date tran3s">12 aug</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Jannatul Ferdaus .</a> 6 min</div>
                                    <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                        ...
                        <div className="isotop-item apartments mortgage home">
                            <article className="blog-meta-one mb-70 lg-mb-40">
                                <figure className="post-img border-25 position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_14.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link date tran3s">09 FEB</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Rashed Ka .</a> 6 min</div>
                        ...
                        <div className="isotop-item villa sale flat">
                            <article className="blog-meta-one mb-70 lg-mb-40">
                                <figure className="post-img border-25 position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_15.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link date tran3s">12 aug</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Jubayer Hasan .</a> 7 min</div>
