    ...
    <div className="main-page-wrapper">
    		...
    		<div className="inner-banner-one inner-banner bg-pink text-center z-1 pt-160 lg-pt-130 pb-160 xl-pb-120 md-pb-80 position-relative">
    			<div className="container">
                    <h3 className="mb-35 xl-mb-20 pt-15">Pricing Plan</h3>
                    ...
                    <div className="pr-table-one">
                        ...
                        <div className="dot-bg-wrapper mt-60 lg-mt-40">
                            <div className="tab-content">
                                <div className="tab-pane show active" id="monthly" role="tabpanel" aria-labelledby="buy-tab" tabIndex="0">
                                    <div className="main-bg d-flex flex-wrap justify-content-end position-relative">
                                        ...
                                        <div className="pr-column-wrapper active">
                                            <div className="pr-header text-center">
                                                <div className="plan text-uppercase">FREE PLAN</div>
                                                <strong className="price fw-500">0</strong>
                                                <p className="fs-16">Great for Individual Person</p>
                                            </div>

                                            <ul className="style-none text-center">
                                                <li>
                                                    <span className="fw-500 color-dark">All Operating Supported</span>
                                                    <div className="icon d-flex align-items-center justify-content-center rounded-circle"><i className="fa-sharp fa-regular fa-xmark"></i></div>
                                                </li>
                                                <li>
                                                    <span className="fw-500 color-dark">All Operating Supported</span>
                                                    <div className="icon d-flex align-items-center justify-content-center rounded-circle"><i className="fa-sharp fa-regular fa-xmark"></i></div>
                                                ...
                                                <li>
                                                    <span className="fw-500 color-dark">All Operating Supported</span>
                                                    <div className="icon d-flex align-items-center justify-content-center rounded-circle available"><i className="fa-sharp fa-regular fa-check"></i></div>
                                                </li>
                                                <li>
                                                    <span className="fw-500 color-dark">All Operating Supported</span>
                                                    <div className="icon d-flex align-items-center justify-content-center rounded-circle available"><i className="fa-sharp fa-regular fa-check"></i></div>
                                            ...
                                            <div className="pr-footer text-center">
                                                <a href="#" className="btn-twelve sm">Active</a>
                                            </div>
                                        </div>

                                        <div className="pr-column-wrapper">
                                            <div className="pr-header text-center">
                                                <div className="plan text-uppercase">Gold Plan</div>
                                                <strong className="price fw-500">$89</strong>
                                                <p className="fs-16">Great for Startup</p>
                                            </div>
                                            ...
                                            <div className="pr-footer text-center">
                                                <a href="#" className="btn-twelve sm">Get Started</a>
                                            </div>
                                        </div>

                                        <div className="pr-column-wrapper">
                                            <div className="pr-header text-center">
                                                <div className="plan text-uppercase">Business Plan</div>
                                                <strong className="price fw-500">$147</strong>
                                                <p className="fs-16">Great for Large Business</p>
                                            </div>
                                ...
                                <div className="tab-pane" id="yearly" role="tabpanel" aria-labelledby="rent-tab" tabIndex="0">
                                    <div className="main-bg d-flex flex-wrap justify-content-end position-relative">
                                        <div className="left-panel d-none d-lg-block">
                                            <ul className="style-none">
                                                <li>All Operating Supported</li>
                                        ...
                                        <div className="pr-column-wrapper">
                                            <div className="pr-header text-center">
                                                <div className="plan text-uppercase">Gold Plan</div>
                                                <strong className="price fw-500">$189</strong>
                                                <p className="fs-16">Great for Startup</p>
                                            </div>
                                        ...
                                        <div className="pr-column-wrapper">
                                            <div className="pr-header text-center">
                                                <div className="plan text-uppercase">Business Plan</div>
                                                <strong className="price fw-500">$347</strong>
                                                <p className="fs-16">Great for Large Business</p>
                                            </div>
