    			...
    			<div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <h3 className="mb-35 xl-mb-30 md-mb-20">Our Agent</h3>
    		...
    		<div className="agent-section-two mt-130 xl-mt-100 mb-150 xl-mb-100">
                <div className="container">
    				<div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-50 lg-mb-40">
    					<div>Showing <span className="color-dark fw-500">1–12</span> of <span className="color-dark fw-500">1,230</span> results</div>
    					<div className="d-flex align-items-center xs-mt-20">
    						<div className="short-filter d-flex align-items-center">
    							<div className="fs-16 me-2">Short by:</div>
    							<select className="nice-select rounded-0">
    								<option value="0">Pupular</option>
                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">7 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_07.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Chris Matial</a></h6>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.1s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">3 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_08.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Mark Filo</a></h6>
    								<div className="designation">Agent</div>
    							</div>
    						</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.2s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">4 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_09.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Zubayer Hasan</a></h6>
    								<div className="designation">Agent</div>
    							</div>
    						</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.3s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">2 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_10.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Jannatul Ferdaus</a></h6>
    								<div className="designation">Agent</div>
    							</div>
    						</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">7 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_11.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Chris Matial</a></h6>
    								<div className="designation">Agent</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.1s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">3 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_12.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Mark Filo</a></h6>
    								<div className="designation">Agent</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.2s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">4 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_13.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Zubayer Hasan</a></h6>
    								<div className="designation">Agent</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.3s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">2 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_14.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Jannatul Ferdaus</a></h6>
    								<div className="designation">Agent</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">7 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_15.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Chris Matial</a></h6>
    								<div className="designation">Agent</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.1s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">3 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_16.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Zubayer Hasan</a></h6>
    								<div className="designation">Agent</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.2s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">4 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_17.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Mark Filo</a></h6>
    								<div className="designation">Agent</div>
    					...
    					<div className="col-xl-3 col-md-4 col-sm-6">
                            <div className="agent-card-two position-relative z-1 mb-50 wow fadeInUp" data-wow-delay="0.3s">
    							<div className="media bg-dark position-relative overflow-hidden">
    								<div className="tag bg-white position-absolute text-uppercase">2 Listing</div>
    								<img src="/images/lazy.svg" data-src="/images/agent/img_18.jpg" alt="" className="lazy-img agent-img w-100 tran5s" />
    							</div>
    							<div className="text-center pt-30">
    								<h6 className="name"><a href="/agent_details" className="stretched-link">Jannatul Ferdaus</a></h6>
    								<div className="designation">Agent</div>
