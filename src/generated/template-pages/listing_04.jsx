    		...
    		<div className="property-listing-six bg-pink-two pt-110 md-pt-80 pb-170 xl-pb-120 mt-150 xl-mt-120">
    			<div className="container">
    				...
    				<div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
                        <div>Showing <span className="color-dark fw-500">1–6</span> of <span className="color-dark fw-500">170</span> results</div>
                        <div className="d-flex align-items-center xs-mt-20">
                            ...
                            <a href="/listing_03" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></a>
                        </div>
                    </div>
                    ...
                    <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                        <div className="d-flex flex-wrap layout-one">
                            <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_28.jpg)" }}>
                                <div className="tag border-20 sale">FOR SELL</div>
                            ...
                            <div className="property-info">
                                <a href="/listing_details_04" className="title tran3s mb-15">Marbel Apartments</a>
                                ...
                                <div className="pl-footer d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <a href="/listing_details_04" className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                        <div className="d-flex flex-wrap layout-one">
                            <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_29.jpg)" }}>
                                <div className="tag border-20">FOR RENT</div>
                                <div className="img-slider-btn">
                                    03 <i className="fa-regular fa-image"></i>
                            ...
                            <div className="property-info">
                                <a href="/listing_details_04" className="title tran3s mb-15">Duplex orkit villa.</a>
                                <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                <div className="feature mt-30 mb-30 pt-30 pb-5">
                                    <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                        <li><strong>2137</strong> sqft</li>
                    ...
                    <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                        <div className="d-flex flex-wrap layout-one">
                            <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_23.jpg)" }}>
                                <div className="tag border-20 sale">FOR SELL</div>
                                <div className="img-slider-btn">
                                    03 <i className="fa-regular fa-image"></i>
                                    <a href="/images/listing/img_large_06.jpg" className="d-block" data-fancybox="img3" data-caption="Luxury villa Dal lake"></a>
                                    <a href="/images/listing/img_large_05.jpg" className="d-block" data-fancybox="img3" data-caption="Luxury villa Dal lake"></a>
                                    <a href="/images/listing/img_large_01.jpg" className="d-block" data-fancybox="img3" data-caption="Luxury villa Dal lake"></a>
                                </div>
                            </div>

                            <div className="property-info">
                                <a href="/listing_details_04" className="title tran3s mb-15">Luxury villa Dal lake</a>
                                <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                <div className="feature mt-30 mb-30 pt-30 pb-5">
                                    <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                        <li><strong>2137</strong> sqft</li>
                    ...
                    <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                        <div className="d-flex flex-wrap layout-one">
                            <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_24.jpg)" }}>
                                <div className="tag border-20">FOR RENT</div>
                                <div className="img-slider-btn">
                                    03 <i className="fa-regular fa-image"></i>
                                    <a href="/images/listing/img_large_01.jpg" className="d-block" data-fancybox="img4" data-caption="Galaxy Touch Flat"></a>
                                    <a href="/images/listing/img_large_03.jpg" className="d-block" data-fancybox="img4" data-caption="Galaxy Touch Flat"></a>
                                    <a href="/images/listing/img_large_06.jpg" className="d-block" data-fancybox="img4" data-caption="Galaxy Touch Flat"></a>
                                </div>
                            </div>

                            <div className="property-info">
                                <a href="/listing_details_04" className="title tran3s mb-15">Galaxy Touch Flat</a>
                                <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                <div className="feature mt-30 mb-30 pt-30 pb-5">
                                    <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                        <li><strong>2137</strong> sqft</li>
                    ...
                    <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                        <div className="d-flex flex-wrap layout-one">
                            <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_21.jpg)" }}>
                                <div className="tag border-20 sale">FOR SELL</div>
                                <div className="img-slider-btn">
                                    03 <i className="fa-regular fa-image"></i>
                                    <a href="/images/listing/img_large_01.jpg" className="d-block" data-fancybox="img5" data-caption="Morpho House"></a>
                                    <a href="/images/listing/img_large_05.jpg" className="d-block" data-fancybox="img5" data-caption="Morpho House"></a>
                                    <a href="/images/listing/img_large_04.jpg" className="d-block" data-fancybox="img5" data-caption="Morpho House"></a>
                                </div>
                            </div>

                            <div className="property-info">
                                <a href="/listing_details_04" className="title tran3s mb-15">Morpho House</a>
                                <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                <div className="feature mt-30 mb-30 pt-30 pb-5">
                                    <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                        <li><strong>2137</strong> sqft</li>
                    ...
                    <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                        <div className="d-flex flex-wrap layout-one">
                            <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_31.jpg)" }}>
                                <div className="tag border-20">FOR RENT</div>
                                <div className="img-slider-btn">
                                    03 <i className="fa-regular fa-image"></i>
                                    <a href="/images/listing/img_large_01.jpg" className="d-block" data-fancybox="img6" data-caption="Oepn Villa"></a>
                                    <a href="/images/listing/img_large_05.jpg" className="d-block" data-fancybox="img6" data-caption="Oepn Villa"></a>
                                    <a href="/images/listing/img_large_04.jpg" className="d-block" data-fancybox="img6" data-caption="Oepn Villa"></a>
                                </div>
                            </div>

                            <div className="property-info">
                                <a href="/listing_details_04" className="title tran3s mb-15">Oepn Villa</a>
                                <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                <div className="feature mt-30 mb-30 pt-30 pb-5">
                                    <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                        <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="pl-footer d-flex flex-wrap align-items-center justify-content-between">
                                    <strong className="price fw-500 color-dark me-auto">$3,120/<sub>m</sub></strong>
                                    <ul className="style-none d-flex action-icons on-top">
                                        <li><a href="#"><i className="fa-light fa-heart"></i></a></li>
                                        <li><a href="#"><i className="fa-light fa-bookmark"></i></a></li>
                                        <li><a href="#"><i className="fa-light fa-circle-plus"></i></a></li>
