                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-xl-5 ms-auto">
                            <p className="fs-24 pt-20">Try Free plan features for 14 days · No credit card required for exploration.</p>
                        </div>
                    </div>
                    <div className="row gx-xxl-5 pt-40 lg-pt-10">
                        <div className="col-lg-4">
                            <div className="pr-column-wrapper active mt-30">
                                ...
                                <div className="pr-footer text-center mt-60">
                                    <a href="#" className="btn-twelve w-100 rounded-0 sm">Subscribe Now</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="pr-column-wrapper mt-30">
                                <div className="pr-header text-center mb-55">
