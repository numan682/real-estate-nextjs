    ...
    <div className="main-page-wrapper">
    		...
    		<div className="project-section-one mt-150 xl-mt-100 mb-170 xl-mb-100">
    			<div className="container">
    				...
    				<div id="isotop-gallery-wrapper" className="grid-1column pt-40 lg-pt-30">
                                ...
                                <div className="row gx-xxl-5 align-items-center">
                                    <div className="col-lg-6">
                                        <figure className="image-wrapper position-relative z-1 overflow-hidden">
                                            <a href="/images/project/img_22.jpg" className="d-block position-relative" data-fancybox data-caption="Apartments on Vintage City">
                                                <img src="/images/project/img_22.jpg" alt="" className="w-100 tran5s" />
                                            </a>
                                        </figure>
                                    </div>
                                    <div className="col-lg-6 ms-auto">
                                        <div className="caption ps-xxl-5">
                                            ...
                                            <h3><a href="/project_details_01">Apartments on Vintage City.</a></h3>
                                            <p className="fs-24 pt-45 lg-pt-30 md-pt-10 pb-50 lg-pb-30 md-pb-10">Your leading real estate advocate, transforming houses into dreams. Trust </p>
                                            <a href="/project_details_01" className="btn-thirteen rounded-circle"><i className="fa-thin fa-arrow-up-right"></i></a>
                                        </div>
                        ...
                        <div className="isotop-item villa">
                            <div className="project-block-three mt-80 lg-mt-50">
                                <div className="row gx-xxl-5 align-items-center">
                                    <div className="col-lg-6">
                                        <figure className="image-wrapper position-relative z-1 overflow-hidden">
                                            <a href="/images/project/img_23.jpg" className="d-block position-relative" data-fancybox data-caption="Galaxy Touch Sky Villa">
                                                <img src="/images/project/img_23.jpg" alt="" className="w-100 tran5s" />
                                            </a>
                                        </figure>
                                    </div>
                                    <div className="col-lg-6 ms-auto">
                                        <div className="caption ps-xxl-5">
                                            ...
                                            <h3><a href="/project_details_01">Galaxy Touch Sky Villa.</a></h3>
                                            <p className="fs-24 pt-45 lg-pt-30 md-pt-10 pb-50 lg-pb-30 md-pb-10">Your leading real estate advocate, transforming houses into dreams. Trust </p>
                                            <a href="/project_details_01" className="btn-thirteen rounded-circle"><i className="fa-thin fa-arrow-up-right"></i></a>
                                        </div>
                        ...
                        <div className="isotop-item apartments">
                            <div className="project-block-three mt-80 lg-mt-50">
                                <div className="row gx-xxl-5 align-items-center">
                                    <div className="col-lg-6">
                                        <figure className="image-wrapper position-relative z-1 overflow-hidden">
                                            <a href="/images/project/img_24.jpg" className="d-block position-relative" data-fancybox data-caption="2370sft Modern Apartments">
                                                <img src="/images/project/img_24.jpg" alt="" className="w-100 tran5s" />
                                            </a>
                                        </figure>
                                    </div>
                                    <div className="col-lg-6 ms-auto">
                                        <div className="caption ps-xxl-5">
                                            <div className="tag fw-500 text-uppercase">APARTMENTS</div>
                                            <h3><a href="/project_details_01">2370sft Modern Apartments.</a></h3>
                                            <p className="fs-24 pt-45 lg-pt-30 md-pt-10 pb-50 lg-pb-30 md-pb-10">Your leading real estate advocate, transforming houses into dreams. Trust </p>
                                            <a href="/project_details_01" className="btn-thirteen rounded-circle"><i className="fa-thin fa-arrow-up-right"></i></a>
                                        </div>
                        ...
                        <div className="isotop-item villa">
                            <div className="project-block-three mt-80 lg-mt-50">
                                <div className="row gx-xxl-5 align-items-center">
                                    <div className="col-lg-6">
                                        <figure className="image-wrapper position-relative z-1 overflow-hidden">
                                            <a href="/images/project/img_25.jpg" className="d-block position-relative" data-fancybox data-caption="2 Store Tiny Duplex House">
                                                <img src="/images/project/img_25.jpg" alt="" className="w-100 tran5s" />
                                            </a>
                                        </figure>
                                    </div>
                                    <div className="col-lg-6 ms-auto">
                                        <div className="caption ps-xxl-5">
                                            ...
                                            <h3><a href="/project_details_01">2 Store Tiny Duplex House.</a></h3>
                                            <p className="fs-24 pt-45 lg-pt-30 md-pt-10 pb-50 lg-pb-30 md-pb-10">Your leading real estate advocate, transforming houses into dreams. Trust </p>
                                            <a href="/project_details_01" className="btn-thirteen rounded-circle"><i className="fa-thin fa-arrow-up-right"></i></a>
                                        </div>
                        ...
                        <div className="isotop-item house">
                            <div className="project-block-three mt-80 lg-mt-50">
                                <div className="row gx-xxl-5 align-items-center">
                                    <div className="col-lg-6">
                                        <figure className="image-wrapper position-relative z-1 overflow-hidden">
                                            <a href="/images/project/img_26.jpg" className="d-block position-relative" data-fancybox data-caption="Swimming Pool Duplex Villa">
                                                <img src="/images/project/img_26.jpg" alt="" className="w-100 tran5s" />
                                            </a>
                                        </figure>
                                    </div>
                                    <div className="col-lg-6 ms-auto">
                                        <div className="caption ps-xxl-5">
                                            <div className="tag fw-500 text-uppercase">VILLA</div>
                                            <h3><a href="/project_details_01">Swimming Pool Duplex Villa.</a></h3>
                                            <p className="fs-24 pt-45 lg-pt-30 md-pt-10 pb-50 lg-pb-30 md-pb-10">Your leading real estate advocate, transforming houses into dreams. Trust </p>
                                            <a href="/project_details_01" className="btn-thirteen rounded-circle"><i className="fa-thin fa-arrow-up-right"></i></a>
                                        </div>
