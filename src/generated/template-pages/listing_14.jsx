    							...
    							<div className="col-xxl-2 col-xl-1">
    								<div className="input-box-one lg-mt-20">
    									<div className="d-flex align-items-center justify-content-center justify-content-xl-end">
    										<a href="#" data-bs-toggle="modal" data-bs-target="#advanceFilterModal" className="search-modal-btn tran3s text-uppercase fw-500 d-inline-flex align-items-center">
    				...
    				<div className="col-xxl-6 col-lg-7">
    					<div className="bg-light pl-40 pr-40 pt-35 pb-60">
    						<div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
    							<div>Showing <span className="color-dark fw-500">1–4</span> of <span className="color-dark fw-500">1,230</span> results</div>
    							<div className="d-flex align-items-center xs-mt-20">
    								...
    								<a href="/listing_15" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To List View"><i className="fa-regular fa-bars"></i></a>
    							</div>
    						</div>


    						<div className="row">
    							<div className="col-md-6 d-flex mb-40 wow fadeInUp">
    								<div className="listing-card-one style-three border-30 w-100 h-100">
    									<div className="img-gallery p-15">
    										<div className="position-relative border-20 overflow-hidden">
    											...
    											<img src="/images/listing/img_39.jpg" className="w-100 border-20" alt="..." />
    											<a href="/listing_details_06" className="btn-four inverse rounded-circle position-absolute"><i className="bi bi-arrow-up-right"></i></a>
    							...
    							<div className="col-md-6 d-flex mb-40 wow fadeInUp" data-wow-delay="0.1s">
    								<div className="listing-card-one style-three border-30 w-100 h-100">
    									<div className="img-gallery p-15">
    										<div className="position-relative border-20 overflow-hidden">
    											<div className="tag bg-white text-dark fw-500 border-20">FOR SELL</div>
    											<img src="/images/listing/img_40.jpg" className="w-100 border-20" alt="..." />
    											<a href="/listing_details_06" className="btn-four inverse rounded-circle position-absolute"><i className="bi bi-arrow-up-right"></i></a>
    											<div className="img-slider-btn">
    												03 <i className="fa-regular fa-image"></i>
    							...
    							<div className="col-md-6 d-flex mb-40 wow fadeInUp">
    								<div className="listing-card-one style-three border-30 w-100 h-100">
    									<div className="img-gallery p-15">
    										<div className="position-relative border-20 overflow-hidden">
    											<div className="tag bg-white text-dark fw-500 border-20">FOR SELL</div>
    											<img src="/images/listing/img_41.jpg" className="w-100 border-20" alt="..." />
    											<a href="/listing_details_06" className="btn-four inverse rounded-circle position-absolute"><i className="bi bi-arrow-up-right"></i></a>
    											<div className="img-slider-btn">
    												04 <i className="fa-regular fa-image"></i>
    												<a href="/images/listing/img_large_01.jpg" className="d-block" data-fancybox="img3" data-caption="Orkit Villa"></a>
    												<a href="/images/listing/img_large_05.jpg" className="d-block" data-fancybox="img3" data-caption="Orkit Villa"></a>
    												<a href="/images/listing/img_large_03.jpg" className="d-block" data-fancybox="img3" data-caption="Orkit Villa"></a>
    												<a href="/images/listing/img_large_02.jpg" className="d-block" data-fancybox="img3" data-caption="Orkit Villa"></a>
    											</div>
    										</div>
    									</div>

    									<div className="property-info pe-4 ps-4">
    										<a href="/listing_details_06" className="title tran3s">Orkit Villa</a>
    							...
    							<div className="col-md-6 d-flex mb-40 wow fadeInUp" data-wow-delay="0.1s">
    								<div className="listing-card-one style-three border-30 w-100 h-100">
    									<div className="img-gallery p-15">
    										<div className="position-relative border-20 overflow-hidden">
    											<div className="tag bg-white text-dark fw-500 border-20">FOR SELL</div>
    											<img src="/images/listing/img_42.jpg" className="w-100 border-20" alt="..." />
    											<a href="/listing_details_06" className="btn-four inverse rounded-circle position-absolute"><i className="bi bi-arrow-up-right"></i></a>
    											<div className="img-slider-btn">
    												04 <i className="fa-regular fa-image"></i>
    									...
    									<div className="property-info pe-4 ps-4">
    										<a href="/listing_details_06" className="title tran3s">South Sun House</a>
    										<div className="address">Mirpur 10, Stadium</div>
    										<div className="pl-footer m0 d-flex align-items-center justify-content-between">
