    			...
    			<div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <h3 className="mb-45 xl-mb-30 md-mb-20">Blog List</h3>
    			...
    			<div className="container">
    				<div className="row gx-xl-5">
                        <div className="col-lg-8">
                            <article className="blog-meta-three mb-70 lg-mb-40 wow fadeInUp">
                                <figure className="post-img position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_11.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link fw-500 date tran3s">17 SEP</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Rashed Kabir .</a> 6 min</div>
                                    <a href="/blog_details" className="blog-title d-block"><h4>Print, publishing qui visual ux layout mockups.</h4></a>
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatu. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</p>
                                    <a href="/blog_details" className="btn-eight"><span>Read More</span> <i className="bi bi-arrow-up-right"></i></a>
                                </div>
                            </article>

                            <article className="blog-meta-three mb-70 lg-mb-40 wow fadeInUp">
                                <figure className="post-img position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_12.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link fw-500 date tran3s">12 JUL</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Rashed Kabir .</a> 6 min</div>
                                    <a href="/blog_details" className="blog-title d-block"><h4>Spending Habits, 13 Tips for grow Your Money</h4></a>
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatu. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</p>
                                    <a href="/blog_details" className="btn-eight"><span>Read More</span> <i className="bi bi-arrow-up-right"></i></a>
                                </div>
                            </article>
                            ...
                            <article className="blog-meta-three mb-70 lg-mb-40 wow fadeInUp">
                                <div className="post-data bg-grey">
                                    <a href="/blog_details" className="fw-500 date tran3s mb-20">12 JUL</a>
                                    <div className="post-info"><a href="/blog_details">Rashed Kabir .</a> 6 min</div>
                                    <a href="/blog_details" className="blog-title d-block"><h4>Medieval to the digital everything there know</h4></a>
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatu. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</p>
                                    <a href="/blog_details" className="btn-eight"><span>Read More</span> <i className="bi bi-arrow-up-right"></i></a>
                                </div>
                            </article>
                            ...
                            <article className="blog-meta-three mb-70 lg-mb-40 wow fadeInUp">
                                <figure className="post-img position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_13.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link fw-500 date tran3s">03 JUN</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Rashed Kabir .</a> 6 min</div>
                                    <a href="/blog_details" className="blog-title d-block"><h4>Speaking remotely at WordCamp US.</h4></a>
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatu. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</p>
                                    <a href="/blog_details" className="btn-eight"><span>Read More</span> <i className="bi bi-arrow-up-right"></i></a>
                                </div>
                            </article>
                            ...
                            <article className="blog-meta-three mb-70 lg-mb-40 wow fadeInUp">
                                <figure className="post-img position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_14.jpg)" }}>
                                    <a href="/blog_details" className="stretched-link fw-500 date tran3s">27 FEB</a>
                                </figure>
                                <div className="post-data">
                                    <div className="post-info"><a href="/blog_details">Rashed Kabir .</a> 6 min</div>
                                    <a href="/blog_details" className="blog-title d-block"><h4>Efficitur id eget nisl. Proin porta est convallis.</h4></a>
                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatu. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</p>
                                    <a href="/blog_details" className="btn-eight"><span>Read More</span> <i className="bi bi-arrow-up-right"></i></a>
                                </div>
                            </article>

                            <ul className="pagination-one square d-flex align-items-center style-none pt-10">
                                <li><a href="#">1</a></li>
    							...
    							<div className="recent-news bg-white bg-wrapper mb-30">
    								...
    								<div className="news-block d-flex align-items-center pb-25">
                                        ...
                                        <div className="post ps-4">
                                            <h4 className="mb-5"><a href="/blog_details" className="title tran3s">10 days quick challenge for boost visitors.</a></h4>
                                    ...
                                    <div className="news-block d-flex align-items-center pb-25">
                                        ...
                                        <div className="post ps-4">
                                            <h4 className="mb-5"><a href="/blog_details" className="title tran3s">Speaking remotely at WordCamp US.</a></h4>
                                            <div className="date">23 July, 2022</div>
                                        </div>
                                    </div>
                                    <div className="news-block d-flex align-items-center">
                                        ...
                                        <div className="post ps-4">
                                            <h4 className="mb-5"><a href="/blog_details" className="title tran3s">Monthly Roundup event December 2022.</a></h4>
                                            <div className="date">23 July, 2022</div>
                                        </div>
                                    </div>
    							</div>
