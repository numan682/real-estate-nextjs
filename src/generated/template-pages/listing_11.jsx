    		...
    		<div className="property-listing-six pt-150 xl-pt-100 pb-170 xl-pb-120">
    			<div className="container">
    				<div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
                        <div>Showing <span className="color-dark fw-500">1–9</span> of <span className="color-dark fw-500">170</span> results</div>
                        <div className="d-flex align-items-center xs-mt-20">
                            ...
                            <a href="/listing_12" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To List View"><i className="fa-regular fa-bars"></i></a>
                        </div>
                    </div>
                    ...
                    <div className="row gx-xxl-5">
                        <div className="col-lg-4 col-md-6 d-flex mb-50 wow fadeInUp">
                            <div className="listing-card-one border-layout border-25 h-100 w-100">
