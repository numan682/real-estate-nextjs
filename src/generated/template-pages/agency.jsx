    			...
    			<div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <h3 className="mb-35 xl-mb-30 md-mb-20">Agency</h3>
                ...
                <div className="container">
                    ...
                    <div className="row gx-xxl-5">
                        <div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp">
                                <div className="tag bg-white position-absolute text-uppercase">27 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_13.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">American Inc</h6>
                                    ...
                                    <a href="/agency_details" className="btn-eight w-100 rounded-0 tran3s">View Listing</a>
    							</div>
    						</div>
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp" data-wow-delay="0.1s">
    							<div className="tag bg-white position-absolute text-uppercase">31 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_14.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">Amazon Build</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp" data-wow-delay="0.2s">
    							<div className="tag bg-white position-absolute text-uppercase">22 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_15.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">Circle Kilo</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp">
    							<div className="tag bg-white position-absolute text-uppercase">12 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_16.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">Payoneer State</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp" data-wow-delay="0.1s">
    							<div className="tag bg-white position-absolute text-uppercase">36 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_17.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">MegaZone</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp" data-wow-delay="0.2s">
    							<div className="tag bg-white position-absolute text-uppercase">16 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_18.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">Muri Retailers Inc</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp">
    							<div className="tag bg-white position-absolute text-uppercase">26 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_19.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">Modernizer</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp" data-wow-delay="0.1s">
    							<div className="tag bg-white position-absolute text-uppercase">19 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_20.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">American Inc</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
    					...
    					<div className="col-lg-4 col-sm-6">
                            <div className="card-style-nine position-relative z-1 mb-50 lg-mb-30 wow fadeInUp" data-wow-delay="0.2s">
    							<div className="tag bg-white position-absolute text-uppercase">19 Listing</div>
    							<div className="logo-wrapper d-flex align-items-center justify-content-center">
    								<img src="/images/lazy.svg" data-src="/images/logo/p_logo_21.png" alt="" className="lazy-img" />
    							</div>
    							<div className="text-center pt-35">
    								<h6 className="agency-name">SolidBuilders</h6>
    								<ul className="rating style-none d-flex justify-content-center align-items-center">
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
                                        <li><i className="fa-sharp fa-solid fa-star"></i></li>
    				...
    				<ul className="pagination-one square d-flex align-items-center justify-content-center style-none pt-40">
                        <li><a href="#">1</a></li>
