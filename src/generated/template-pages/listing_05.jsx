                            ...
                            <div className="ps-xxl-5">
                                <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
    								...
    								<div className="d-flex align-items-center xs-mt-20">
    									...
    									<a href="/listing_06" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To List View"><i className="fa-regular fa-bars"></i></a>
    								</div>
    							</div>
                                ...
                                <div className="row gx-xxl-5">
                                    <div className="col-md-6 d-flex mb-50 wow fadeInUp">
                                        <div className="listing-card-one style-two shadow-none h-100 w-100">
                                            ...
                                            <div className="property-info pt-20">
                                                <a href="/listing_details_05" className="title tran3s">Blueberry villa</a>
                                                ...
                                                <div className="pl-footer top-border bottom-border d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="/listing_details_05" className="btn-four"><i className="bi bi-arrow-up-right"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-md-6 d-flex mb-50 wow fadeInUp" data-wow-delay="0.1s">
                                        <div className="listing-card-one style-two shadow-none h-100 w-100">
                                            ...
                                            <div className="property-info pt-20">
                                                <a href="/listing_details_05" className="title tran3s">White House villa</a>
                                    ...
                                    <div className="col-md-6 d-flex mb-50 wow fadeInUp" data-wow-delay="0.2s">
                                        <div className="listing-card-one style-two shadow-none h-100 w-100">
                                            <div className="img-gallery">
                                                <div className="position-relative overflow-hidden">
                                                    <div className="tag fw-500">FOR RENT</div>
