                        ...
                        <div className="col-lg-8">
                            <div className="ps-xxl-5">
                                <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
    								<div>Showing <span className="color-dark fw-500">1–8</span> of <span className="color-dark fw-500">1,230</span> results</div>
    								<div className="d-flex align-items-center xs-mt-20">
    									...
    									<a href="/listing_02" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To List View"><i className="fa-regular fa-bars"></i></a>
    								</div>
    							</div>
                                ...
                                <div className="row gx-xxl-5">
                                    <div className="col-md-6 d-flex mb-50 wow fadeInUp">
                                        <div className="listing-card-one border-25 h-100 w-100">
                                            ...
                                            <div className="property-info p-25">
                                                <a href="/listing_details_01" className="title tran3s">Blueberry villa</a>
                                                ...
                                                <div className="pl-footer top-border d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="/listing_details_01" className="btn-four rounded-circle"><i className="bi bi-arrow-up-right"></i></a>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-md-6 d-flex mb-50 wow fadeInUp" data-wow-delay="0.1s">
                                        <div className="listing-card-one border-25 h-100 w-100">
                                            <div className="img-gallery p-15">
                                                <div className="position-relative border-25 overflow-hidden">
                                            ...
                                            <div className="property-info p-25">
                                                <a href="/listing_details_01" className="title tran3s">White House villa</a>
                                    ...
                                    <div className="col-md-6 d-flex mb-50 wow fadeInUp">
                                        <div className="listing-card-one border-25 h-100 w-100">
                                            ...
                                            <div className="property-info p-25">
                                                <a href="/listing_details_01" className="title tran3s">Luxury villa in Dal lake.</a>
