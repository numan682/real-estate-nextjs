                        ...
                        <div className="col-lg-8">
                            <div className="ps-xxl-5">
                                <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
    								<div>Showing <span className="color-dark fw-500">1–5</span> of <span className="color-dark fw-500">1,125</span> results</div>
    								<div className="d-flex align-items-center xs-mt-20">
    									...
    									<a href="/listing_01" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></a>
    								</div>
    							</div>
                                ...
                                <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info">
                                            <a href="/listing_details_02" className="title tran3s mb-15">Marbel Apartments</a>
                                ...
                                <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info">
                                            <a href="/listing_details_02" className="title tran3s mb-15">Duplex orkit villa.</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info">
                                            <a href="/listing_details_02" className="title tran3s mb-15">Luxury villa Dal lake</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info">
                                            <a href="/listing_details_02" className="title tran3s mb-15">Galaxy Touch Flat</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven border-20 p-20 mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info">
                                            <a href="/listing_details_02" className="title tran3s mb-15">Morpho House</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
