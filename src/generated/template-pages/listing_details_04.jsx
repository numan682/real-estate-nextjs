    						...
    						<div className="col-xl-8">
    							<div className="dark-bg ps-5 pe-5 pt-25 pb-25 m-inverse">
    								<ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
    									<li>
    										<img src="/images/lazy.svg" data-src="/images/icon/icon_58.svg" alt="" className="lazy-img icon sm" />
    										<span className="fs-20 text-white">Sqft . 3,720</span>
    									</li>
    									<li>
    										<img src="/images/lazy.svg" data-src="/images/icon/icon_59.svg" alt="" className="lazy-img icon sm" />
    										<span className="fs-20 text-white">Bed . 03</span>
    									</li>
    									<li>
    										<img src="/images/lazy.svg" data-src="/images/icon/icon_60.svg" alt="" className="lazy-img icon sm" />
    										<span className="fs-20 text-white">Bath . 2</span>
    									</li>
    									<li>
    										<img src="/images/lazy.svg" data-src="/images/icon/icon_61.svg" alt="" className="lazy-img icon sm" />
    								...
    								<div className="item">
    									<div className="listing-card-one shadow-none style-two mb-50">
    										...
    										<div className="property-info d-flex justify-content-between align-items-end pt-30">
    											...
    											<a href="/listing_details_01" className="btn-four mb-5"><i className="bi bi-arrow-up-right"></i></a>
    										</div>
