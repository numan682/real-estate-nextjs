    				...
    				<div className="row">
                        <div className="col-lg-6">
                            ...
                            <div className="d-flex flex-wrap mt-10">
                                <div className="list-type bg-white text-dark fw-500 text-uppercase mt-15 me-3">FOR SELL</div>
                        ...
                        <div className="col-lg-6 text-lg-end">
                            <div className="d-inline-block md-mt-40">
                                ...
                                <ul className="style-none d-flex align-items-center action-btns">
                                    ...
                                    <li><a href="#" className="d-flex align-items-center justify-content-center tran3s"><i className="fa-light fa-heart"></i></a></li>
                                    <li><a href="#" className="d-flex align-items-center justify-content-center tran3s"><i className="fa-light fa-bookmark"></i></a></li>
                                    <li><a href="#" className="d-flex align-items-center justify-content-center tran3s"><i className="fa-light fa-circle-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    				<div className="row pt-80 lg-pt-50">
    					<div className="col-xl-8">
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="position-relative">
                                            <a href="/images/listing/img_61.jpg" className="media-bg lg" data-fancybox style={{ backgroundImage: "url(images/listing/img_61.jpg)" }}></a>
                                            <div className="img-fancy-btn fw-500 fs-16 color-dark">
                                                Sell all 37 Photos
                                                <a href="/images/listing/img_large_01.jpg" className="d-block" data-fancybox="mainImg" data-caption="Duplex orkit villa."></a>
                                                <a href="/images/listing/img_large_02.jpg" className="d-block" data-fancybox="mainImg" data-caption="Duplex orkit villa."></a>
                                                <a href="/images/listing/img_large_03.jpg" className="d-block" data-fancybox="mainImg" data-caption="Duplex orkit villa."></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12">
                                        <div className="row">
                                            <div className="col-md-3 col-6 mt-15">
                                                <a href="/images/listing/img_62.jpg" className="media-bg xs" data-fancybox style={{ backgroundImage: "url(images/listing/img_62.jpg)" }}></a>
                                            </div>
                                            <div className="col-md-3 col-6 mt-15">
                                                <a href="/images/listing/img_63.jpg" className="media-bg xs" data-fancybox style={{ backgroundImage: "url(images/listing/img_63.jpg)" }}></a>
                                            </div>
                                            <div className="col-md-3 col-6 mt-15">
                                                <a href="/images/listing/img_64.jpg" className="media-bg xs" data-fancybox style={{ backgroundImage: "url(images/listing/img_64.jpg)" }}></a>
                                            </div>
                                            <div className="col-md-3 col-6 mt-15">
                                                <a href="/images/listing/img_65.jpg" className="media-bg xs" data-fancybox style={{ backgroundImage: "url(images/listing/img_65.jpg)" }}></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    						...
    						<div className="property-amenities bottom-line-dark pb-40 mb-60">
    							...
    							<p className="fs-20 lh-lg pb-25">Risk management and compliance, when approached strategically, have the potential to go beyond mitigating threats and protecting a company’s</p>
    									...
    									<div className="listing-card-one shadow-none style-two mb-50">
    										<div className="img-gallery">
    											<div className="position-relative overflow-hidden">
    												...
    												<img src="/images/listing/img_13.jpg" className="w-100" alt="..." />
    										...
    										<div className="property-info d-flex justify-content-between align-items-end pt-30">
    											<div>
    												...
    												<div className="address m0">Mirpur 10, Stadium dhaka</div>
    											</div>
    											<a href="/listing_01" className="btn-four mb-5"><i className="bi bi-arrow-up-right"></i></a>
    										</div>
    									...
    									<div className="listing-card-one shadow-none style-two mb-50">
    										<div className="img-gallery">
    											<div className="position-relative overflow-hidden">
    												...
    												<img src="/images/listing/img_14.jpg" className="w-100" alt="..." />
    												<div className="img-slider-btn">
    													03 <i className="fa-regular fa-image"></i>
    										...
    										<div className="property-info d-flex justify-content-between align-items-end pt-30">
    											<div>
    												<strong className="price fw-500 color-dark">$28,710</strong>
    												<div className="address m0">Mirpur 10, Stadium dhaka</div>
    											</div>
    											<a href="/listing_01" className="btn-four mb-5"><i className="bi bi-arrow-up-right"></i></a>
    										</div>
    								...
    								<div className="item">
    									<div className="listing-card-one shadow-none style-two mb-50">
    										<div className="img-gallery">
    											<div className="position-relative overflow-hidden">
    												<div className="tag bg-white text-dark fw-500">FOR SELL</div>
    												<img src="/images/listing/img_15.jpg" className="w-100" alt="..." />
    												<div className="img-slider-btn">
    								...
    								<div className="item">
    									<div className="listing-card-one shadow-none style-two mb-50">
    										<div className="img-gallery">
    											<div className="position-relative overflow-hidden">
    												<div className="tag bg-white text-dark fw-500">FOR SELL</div>
    												<img src="/images/listing/img_16.jpg" className="w-100" alt="..." />
    												<div className="img-slider-btn">
    													04 <i className="fa-regular fa-image"></i>
    						...
    						<div className="review-panel-one bottom-line-dark pb-40 mb-60">
    							<div className="position-relative z-1">
    								...
    								<div className="load-more-review text-uppercase w-100 inverse rounded-0 border-15 tran3s">VIEW ALL 120 REVIEWS <i className="bi bi-arrow-up-right"></i></div>
    							</div>						
    						</div>
    					...
    					<div className="col-xl-4 col-lg-8 me-auto ms-auto">
    						<div className="theme-sidebar-one dot-bg p-30 ms-xxl-3 lg-mt-80">
    							<div className="agent-info bg-white p-30 mb-40">
    								...
    								<a href="#" className="btn-nine text-uppercase w-100 mb-10">CONTACT AGENT</a>
    							</div>
    							...
    							<div className="tour-schedule bg-white p-30 mb-40">
    								...
    								<form action="#">
    									<div className="input-box-three mb-25">
    										...
    										<input type="text" placeholder="Your full name" className="type-input rounded-0" />
    									</div>
    									...
    									<button className="btn-nine text-uppercase w-100 mb-10">INQUIry</button>
    								</form>
    							</div>
