                            ...
                            <div className="ps-xxl-5">
                                <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
    								...
    								<div className="d-flex align-items-center xs-mt-20">
    									...
    									<a href="/listing_05" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></a>
    								</div>
    							</div>
                                ...
                                <div className="listing-card-seven grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info pe-4 ps-4">
                                            <a href="/listing_details_06" className="title tran3s mb-15">Marbel Apartments</a>
                                ...
                                <div className="listing-card-seven grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info pe-4 ps-4">
                                            <a href="/listing_details_06" className="title tran3s mb-15">Duplex orkit villa.</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature border-0 mt-45 mb-30">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info pe-4 ps-4">
                                            <a href="/listing_details_06" className="title tran3s mb-15">Oepn Villa</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature border-0 mt-45 mb-30">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info pe-4 ps-4">
                                            <a href="/listing_details_06" className="title tran3s mb-15">Shite House</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature border-0 mt-45 mb-30">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info pe-4 ps-4">
                                            <a href="/listing_details_06" className="title tran3s mb-15">Modern Flat</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature border-0 mt-45 mb-30">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <ul className="pagination-one square d-flex align-items-center justify-content-center justify-content-sm-start style-none pt-60 lg-pt-30">
                                    <li><a href="#">1</a></li>
