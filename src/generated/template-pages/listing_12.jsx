...
export default function TemplatePage() {
  return (
    ...
    <div className="main-page-wrapper">
                                            ...
                                            <div className="col-xl-3 col-lg-4">
                                                <div className="input-box-one md-mt-10">
                                                    <div className="d-flex align-items-center justify-content-center justify-content-lg-end">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#advanceFilterModal" className="search-modal-btn sm rounded-circle tran3s text-uppercase fw-500 d-inline-flex align-items-center justify-content-center me-3">
    		...
    		<div className="property-listing-six pt-150 xl-pt-100 pb-170 xl-pb-120">
    			<div className="container container-large">
    				<div className="row">
                        <div className="col-lg-8">
                            <div className="ps-xxl-5">
                                <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
    								<div>Showing <span className="color-dark fw-500">1–5</span> of <span className="color-dark fw-500">1,230</span> results</div>
    								<div className="d-flex align-items-center xs-mt-20">
    									...
    									<a href="/listing_11" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></a>
    								</div>
    							</div>


                                <div className="listing-card-seven border-20 p-20 grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info">
                                            <a href="#" className="title tran3s mb-15">Marbel Apartments</a>
                                ...
                                <div className="listing-card-seven border-20 p-20 grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        ...
                                        <div className="property-info">
                                            <a href="#" className="title tran3s mb-15">Duplex orkit villa.</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven border-20 p-20 grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_37.jpg)" }}>
                                            <div className="tag bg-white rounded-0 text-dark fw-500">FOR SELL</div>
                                            <div className="img-slider-btn">
                                                03 <i className="fa-regular fa-image"></i>
                                        ...
                                        <div className="property-info">
                                            <a href="#" className="title tran3s mb-15">Oepn Villa</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven border-20 p-20 grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_36.jpg)" }}>
                                            <div className="tag bg-white rounded-0 text-dark fw-500">FOR RENT</div>
                                            <div className="img-slider-btn">
                                                03 <i className="fa-regular fa-image"></i>
                                        ...
                                        <div className="property-info">
                                            <a href="#" className="title tran3s mb-15">Shite House</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <div className="listing-card-seven border-20 p-20 grey-bg mb-50 wow fadeInUp">
                                    <div className="d-flex flex-wrap layout-one">
                                        <div className="img-gallery position-relative z-1 border-20 overflow-hidden" style={{ backgroundImage: "url(images/listing/img_35.jpg)" }}>
                                            <div className="tag bg-white rounded-0 text-dark fw-500">FOR SELL</div>
                                            <div className="img-slider-btn">
                                                03 <i className="fa-regular fa-image"></i>
                                        ...
                                        <div className="property-info">
                                            <a href="#" className="title tran3s mb-15">Modern Flat</a>
                                            <div className="address">Mirpur 10, National Stadium, 1210, Dhaka, BD</div>
                                            <div className="feature mt-30 mb-30 pt-30 pb-5">
                                                <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                    <li><strong>2137</strong> sqft</li>
                                ...
                                <ul className="pagination-one d-flex align-items-center justify-content-center justify-content-sm-start style-none pt-60 lg-pt-20">
                                    <li><a href="#">1</a></li>
                        ...
                        <div className="col-lg-4 order-lg-first">
                            <div className="advance-search-panel dot-bg md-mt-80">
                                <div className="main-bg border-layout">
                                    <form action="#">
