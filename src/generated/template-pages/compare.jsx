    			...
    			<div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <h3 className="mb-45 xl-mb-30 md-mb-20">Compare</h3>
                        ...
                        <div className="table-responsive table-bg bg-white">
                            <table className="table">
                                            ...
                                            <div className="listing-card-one style-two shadow-none">
                                                <div className="img-gallery">
                                                    <div className="position-relative overflow-hidden">
                                                        ...
                                                        <a href="#" className="d-block"><img src="/images/listing/img_66.jpg" className="w-100" alt="..." /></a>
                                                    </div>
                                                </div>

                                                <div className="property-info pt-10">
                                                    <a href="#" className="title tran3s">Blueberry villa</a>
                                                    <div className="address">2972 Westheimer Rd. Santa Ana, Illinois 85486 </div>
                                                </div>
                                            ...
                                            <div className="listing-card-one style-two shadow-none">
                                                <div className="img-gallery">
                                                    <div className="position-relative overflow-hidden">
                                                        <div className="tag fw-500">FOR SELL</div>
                                                        <a href="#" className="fav-btn tran3s"><i className="fa-light fa-heart"></i></a>
                                                        <a href="#" className="d-block"><img src="/images/listing/img_67.jpg" className="w-100" alt="..." /></a>
                                                    </div>
                                                </div>

                                                <div className="property-info pt-10">
                                                    <a href="#" className="title tran3s">Orkit Flat</a>
                                                    <div className="address">2118 Thornridge Cir. Syracuse, Connecticut 35624</div>
                                                </div>
                                            ...
                                            <div className="listing-card-one style-two shadow-none">
                                                <div className="img-gallery">
                                                    <div className="position-relative overflow-hidden">
                                                        <div className="tag fw-500">FOR SELL</div>
                                                        <a href="#" className="fav-btn tran3s"><i className="fa-light fa-heart"></i></a>
                                                        <a href="#" className="d-block"><img src="/images/listing/img_68.jpg" className="w-100" alt="..." /></a>
                                                    </div>
                                                </div>

                                                <div className="property-info pt-10">
                                                    <a href="#" className="title tran3s">Modu Apartment</a>
                                                    <div className="address">1901 Thornridge Cir. Shiloh, Hawaii 81063</div>
                                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Features</th>
                                        <td>Ac/Heating, Laundry, Garden, Elevator, Pet Friendly, Wifi, Refrigerator</td>
                                        <td>Ac/Heating,  Garden, Wifi, Pet Friendly, Refrigerator</td>
                                        <td>Ac/Heating, Laundry, Garden, Elevator, Pet Friendly, Wifi, Refrigerator, Fireplace, Swimming Pool</td>
                                    </tr>
                                    <tr>
                                        <th>Zoning</th>
                                        <td>Residential</td>
