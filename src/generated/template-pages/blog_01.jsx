    			...
    			<div className="container">
                    <div className="row">
                        <div className="col-lg-6">
                            <h3 className="mb-45 xl-mb-30 md-mb-20">Blog Grid</h3>
    				...
    				<div className="row">
                        <div className="col-lg-8">
                            <div className="row gx-xxl-5">
                                    ...
                                    <article className="blog-meta-two tran3s position-relative z-1 mb-70 lg-mb-40 wow fadeInUp">
                                        ...
                                        <div className="post-data">
                                            ...
                                            <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                                                <a href="/blog_details" className="blog-title"><h4>Speaking remotely at WordCamp US.</h4></a>
                                        ...
                                        <div className="hover-content tran3s">
                                            ...
                                            <a href="/blog_details" className="btn-four inverse rounded-circle"><i className="fa-thin fa-arrow-up-right"></i></a>
                                        </div>
                                ...
                                <div className="col-md-6">
                                    <article className="blog-meta-two tran3s position-relative z-1 mb-70 lg-mb-40 wow fadeInUp">
                                        <figure className="post-img position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_05.jpg)" }}>
                                            <a href="/blog_details" className="date">14 JUN</a>
                                        </figure>
                                        <div className="post-data">
                                            <div className="post-info"><a href="/blog_details">Jannatul Ferdaus .</a> 7 min</div>
                                            <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                                ...
                                <div className="col-md-6">
                                    <article className="blog-meta-two tran3s position-relative z-1 mb-70 lg-mb-40 wow fadeInUp">
                                        <figure className="post-img position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_06.jpg)" }}>
                                            <a href="/blog_details" className="date">07 Feb</a>
                                        </figure>
                                        <div className="post-data">
                                            <div className="post-info"><a href="/blog_details">Jubayer Hasan .</a> 5 min</div>
                                            <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                                ...
                                <div className="col-md-6">
                                    <article className="blog-meta-two tran3s position-relative z-1 mb-70 lg-mb-40 wow fadeInUp">
                                        <figure className="post-img position-relative m0" style={{ backgroundImage: "url(images/blog/blog_img_07.jpg)" }}>
                                            <a href="/blog_details" className="date">21 SEP</a>
                                        </figure>
                                        <div className="post-data">
                                            <div className="post-info"><a href="/blog_details">Mahfuz Riad .</a> 6 min</div>
                                            <div className="d-flex justify-content-between align-items-sm-center flex-wrap">
                                                <a href="/blog_details" className="blog-title"><h4>Efficitur id eget nisl. Proin porta est convallis.</h4></a>
                                                <a href="#" className="btn-four"><i className="bi bi-arrow-up-right"></i></a>
                                            </div>
                                        </div>
                                        <div className="hover-content tran3s">
                            ...
                            <ul className="pagination-one square d-flex align-items-center style-none pt-30">
                                <li><a href="#">1</a></li>
                        ...
                        <div className="col-lg-4">
    						<div className="blog-sidebar dot-bg ms-xxl-5 md-mt-60">
