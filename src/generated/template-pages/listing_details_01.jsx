                                    ...
                                    <div className="position-relative z-1 overflow-hidden border-20">
                                        ...
                                        <div className="carousel-inner">
                                            <div className="carousel-item active">
                                                <img src="/images/listing/img_43.jpg" alt="" className="border-20 w-100" />
                                            </div>
                                            <div className="carousel-item">
                                                <img src="/images/listing/img_44.jpg" alt="" className="border-20 w-100" />
                                            </div>
                                            <div className="carousel-item">
                                                <img src="/images/listing/img_45.jpg" alt="" className="border-20 w-100" />
                                            </div>
                                            <div className="carousel-item">
                                                <img src="/images/listing/img_46.jpg" alt="" className="border-20 w-100" />
                                            </div>
                                        </div>
