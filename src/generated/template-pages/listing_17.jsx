    					...
    					<div className="pl-40 pr-40 pt-35 pb-60">
    						...
    						<div className="listing-header-filter d-sm-flex justify-content-between align-items-center mt-50 mb-50">
    							...
    							<div className="d-flex align-items-center xs-mt-20">
    								...
    								<a href="/listing_16" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></a>
    							</div>
    						</div>


    						<div className="listing-card-seven border-top border-bottom mb-50 wow fadeInUp">
                                <div className="d-flex flex-wrap layout-one">
                                    ...
                                    <div className="property-info pe-0">
                                        ...
                                        <div className="address fs-16"><i className="bi bi-geo-alt"></i> 3891 Ranchview, California 62639</div>
                                        ...
                                        <div className="pl-footer pb-15 d-flex align-items-center justify-content-between">
                                            <strong className="price sm fw-500 w-100 color-dark m0">$24,000</strong>
                                            <ul className="style-none d-flex action-icons on-top">
                                                <li><a href="#"><i className="fa-light fa-heart"></i></a></li>
                                            </ul>
                                            <a href="/listing_details_02" className="btn-four"><i className="bi bi-arrow-up-right"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div className="listing-card-seven border-top border-bottom mb-50 wow fadeInUp">
                                <div className="d-flex flex-wrap layout-one">
                                    ...
                                    <div className="property-info pe-0">
                                        ...
                                        <div className="pl-footer pb-15 d-flex align-items-center justify-content-between">
                                            <strong className="price sm fw-500 w-100 color-dark m0">$2,370/<sub>m</sub></strong>
                                            <ul className="style-none d-flex action-icons on-top">
                                                <li><a href="#"><i className="fa-light fa-heart"></i></a></li>
                                            </ul>
                                            <a href="/listing_details_02" className="btn-four"><i className="bi bi-arrow-up-right"></i></a>
                            ...
                            <div className="listing-card-seven border-top border-bottom mb-50 wow fadeInUp">
                                <div className="d-flex flex-wrap layout-one">
                                    ...
                                    <div className="property-info pe-0">
                                        <a href="/listing_details_02" className="title tran3s mb-15">Oepn Villa</a>
                                        <div className="address fs-16"><i className="bi bi-geo-alt"></i> 3891 Ranchview, California 62639</div>
                                        <div className="feature border-0 mt-45 mb-30">
                                            <ul className="style-none d-flex flex-wrap align-items-center justify-content-between">
                                                <li><strong>2137</strong> sqft</li>
                                        ...
                                        <div className="pl-footer pb-15 d-flex align-items-center justify-content-between">
                                            <strong className="price sm fw-500 w-100 color-dark m0">$43,000</strong>
                                            <ul className="style-none d-flex action-icons on-top">
                                                <li><a href="#"><i className="fa-light fa-heart"></i></a></li>
                                            </ul>
                                            <a href="/listing_details_02" className="btn-four"><i className="bi bi-arrow-up-right"></i></a>
