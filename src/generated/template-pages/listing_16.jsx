    					...
    					<div className="pl-40 pr-40 pt-35 pb-60">
    						...
    						<div className="listing-header-filter d-sm-flex justify-content-between align-items-center mt-50 mb-30">
    							...
    							<div className="d-flex align-items-center xs-mt-20">
    								...
    								<a href="/listing_17" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To List View"><i className="fa-regular fa-bars"></i></a>
    							</div>
    						</div>
