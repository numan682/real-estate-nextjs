...
export function BlockFeatureFourSection() {
  return (
        				...
        				<div className="row">
        					<div className="col-lg-6 d-flex order-lg-last">
        						<div className="ps-xxl-5 ms-xl-4 pt-100 xl-pt-80 pb-45 w-100 h-100 wow fadeInRight">
        							...
        							<div className="fs-16 mt-10 opacity-75">*For accurate info please <a href="/contact" className="fst-italic color-dark text-decoration-underline">contact us.</a></div>
        						</div>
        					</div>
        					<div className="col-lg-6 d-flex">
        						<div className="img-gallery position-relative z-1 w-100 h-100 me-lg-5 wow fadeInLeft">
        							<div className="img-bg" style={{ backgroundImage: "url(images/media/img_11.jpg)" }}></div>
        							<div className="card-one">
        								<div className="text text-center z-1">
        									<h6>Your estimate is in!</h6>
        									<h3>$378,30.00</h3>
        								</div>
        								<img src="/images/lazy.svg" data-src="/images/assets/screen_12.png" alt="" className="lazy-img w-100" />
        							</div>
        						</div>
