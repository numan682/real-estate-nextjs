...
export function BlockFeatureTwoSection() {
  return (
        					...
        					<div className="col-xxl-7 col-md-6 d-flex wow fadeInLeft">
        						<div className="block-one w-100 h-100">
        							<div className="position-relative z-1 h-100">
        								...
        								<a className="fancybox video-icon d-flex align-items-center justify-content-center rounded-circle ms-3" data-fancybox="" href="https://www.youtube.com/embed/aXFSJTjVjw0" tabIndex={-1}>
        								...
        								<img src="/images/lazy.svg" data-src="/images/assets/screen_01.png" alt="" className="lazy-img shapes screen_01" />
        							</div>
        						</div>
        						...
        						<div className="block-two">
        							<div className="bg-wrapper">
        								...
        								<div className="d-inline-flex flex-wrap align-items-center mt-15 md-mt-10">
        									<a href="/about_us_01" className="btn-two mt-20 me-4"><span>More Details</span></a>
